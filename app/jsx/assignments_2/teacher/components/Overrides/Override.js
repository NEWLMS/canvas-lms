...
export default class Override extends React.Component {
  ...
  handleChangeOverride = (path, value) => this.props.onChangeOverride(this.props.index, path, value)

  handleValidate = (path, value) => this.props.onValidate(this.props.index, path, value)

  invalidMessage = path => this.props.invalidMessage(this.props.index, path)
